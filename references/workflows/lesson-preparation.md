...
使用 `assets/templates/02-teaching-design.md`，并完整执行 `teacher-ready-content.md` 与 `teaching-design-decision-review.md`。先完成内部课程导演推演：标注学情证据，识别关键学习障碍及其类型，确定一个核心达成、最多两个必要支撑、唯一突破口、明确舍弃和课堂路径；这些内容不逐项打印。
